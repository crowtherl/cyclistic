...
This program uses the tidyverse package to import and clean the data, the lubridate package for date functions, the scales package for visualization labels, and the geosphere package to calculate distances.
...
Casual riders go on fewer, but longer, rides, and spend more overall time riding.
